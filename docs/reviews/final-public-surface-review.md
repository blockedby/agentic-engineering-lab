...
- Go OpenRouter PR #1: `https://github.com/blockedby/go-openrouter/pull/1`, state `OPEN`.
- Linux/Kubuntu tweaks PR #1: `https://github.com/blockedby/linux-kubuntu-tweaks/pull/1`, state `OPEN`.
- Pi Codex PR #1: `https://github.com/blockedby/pi-codex/pull/1`, state `OPEN`.
...
- Public PRs that remain open are described as open.
